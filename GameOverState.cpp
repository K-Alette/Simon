...
{
	if (IH::Instance()->isKeyDown(SDL_SCANCODE_ESCAPE)) //pause when user hits escape
	{
...
{
	Simon::Instance()->getStateMachine()->changeState(new MainMenuState());
}

void GameOverState::s_restartPlay()
{
	Simon::Instance()->getStateMachine()->changeState(new PlayState());
}
